...
const Hero = () => {
  return (
    <div className='flex flex-col items-center justify-center  w-full md:pt-36 pt-20 px-7 md:px-0 space-y-7 text-center bg-gradient-to-b from-green-100/70'>
      ...
      <h1 className='md:text-4xl text-2xl  relative font-bold text-gray-800 max-w-3xl mx-auto'><span className='text-red-400'>VFM- </span>Empower Your future with the courses designed to <span className='text-green-600'>fit your choice.</span><img src={assets.sketch} alt="sketch" className='md:block hidden absolute-bottom-7 right-0'></img></h1>
