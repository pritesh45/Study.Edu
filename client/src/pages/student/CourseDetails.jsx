...
<div
  ...
  style={{ height: "500px" }} // Directly using the value
></div>     
{/* left column */}
 <div className='max-w-xl z-10 text-gray-500'>
 <h1 
  className="font-semibold text-gray-800"
  style={{ fontSize: window.innerWidth >= 768 ? "36px" : "26px", lineHeight: window.innerWidth >= 768 ? "44px" : "34px" }}
>
  ...
  <div className='flex items-center space-x-2 pt-3 pb-1 text-sm'>
          ...
          <p className='text-sm'>Course by <span className='text-blue-600 underline' >VFM</span></p>
                ...
                <div key={index} className='border border-gray-300 bg-white mb-2 rounded'>
                  <div className='flex items-center justify-between px-4 py-3 cursor-pointer select-none' onClick={()=>toggleSection(index)}>
                    <div className='flex items-center gap-2'>
                      ...
                      src={assets.down_arrow_icon}alt="arrow icon"></img>
